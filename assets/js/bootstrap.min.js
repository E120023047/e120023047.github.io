    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (p) {
                ...
                a = "bottom" == a && h.bottom + c > f.bottom ? "top" : "top" == a && h.top - c < f.top ? "bottom" : "right" == a && h.right + d > f.width ? "left" : "left" == a && h.left - d < f.left ? "right" : a, s.removeClass(u).addClass(a)
            }
            var g = this.getCalculatedOffset(a, h, d, c);
        ...
        var e = this.$element;
        (e.attr("title") || "string" != typeof e.attr("data-original-title")) && e.attr("data-original-title", e.attr("title") || t(e.data("content")).html() || "").attr("title", "")
...
function(t) {
    ...
    i.VERSION = "3.3.7", i.DEFAULTS = t.extend({}, t.fn.tooltip.Constructor.DEFAULTS, {
        ...
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title bold"></h3><div class="popover-content"></div></div>'
        ...
        var e = this.$element,
            i = this.options;
        return t(e.data("content")).html() || e.attr("data-content") || ("function" == typeof i.content ? i.content.call(e[0]) : i.content)
    }, i.prototype.arrow = function() {
    ...
    $("[rel=popover]").popover({
        ...
        container: "#conteneur",
        content: function() {
            return $(this).attr("data-content-id") ? $($(this).attr("data-content-id")).html() : ""
        }
    }), $("[rel=tooltip]").tooltip({
        container: "#conteneur",
        html: !0,
